...
var n = 10; // Obtener los primeros 10 números de Fibonacci
var fibSequence = fibonacci(n); // Llamamos a la función fibonacci con n = 10
// Imprimimos en la consola los resultados
console.log("Los primeros ".concat(n, " n\u00FAmeros de Fibonacci son: ").concat(fibSequence.join(', ')));
